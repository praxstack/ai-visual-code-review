...
class ReviewWebviewProvider {
    constructor(context, gitService, diffService) {
    ...
    async createOrShowPanel() {
        ...
        this._panel = vscode.window.createWebviewPanel(ReviewWebviewProvider.viewType, 'AI Code Review', column || vscode.ViewColumn.One, {
            enableScripts: true,
     ...
     */
    async exportForAI(comments, lineComments) {
...
ReviewWebviewProvider.viewType = 'aiCodeReviewWebview';
//# sourceMappingURL=reviewWebviewProvider.js.map